 ...
 * 
 * This is the primary color mode for the hacker theme.
 * All color tokens are defined here following EUI's type structure.
 */
...
import {
  ...
  type _EuiThemeBackgroundColors,
  type _EuiThemeBorderColors,
  type _EuiThemeTransparentBackgroundColors,
...
export const dark_brand_colors: _EuiThemeBrandColors = {
  primary: SEMANTIC_COLORS.primary100,
  accent: SEMANTIC_COLORS.accent100,
  accentSecondary: SEMANTIC_COLORS.accentSecondary100,
  success: SEMANTIC_COLORS.success80,
  warning: SEMANTIC_COLORS.warning40,
  danger: SEMANTIC_COLORS.danger80,
};
...
export const dark_brand_text_colors: _EuiThemeBrandTextColors = {
  ...
  successText: SEMANTIC_COLORS.success80,
  warningText: SEMANTIC_COLORS.warning30,
  dangerText: SEMANTIC_COLORS.danger80,
...
export const dark_border_colors: _EuiThemeBorderColors = {
  ...
  borderBaseFloating: SEMANTIC_COLORS.primary60,

  borderBaseFormsColorSwatch: SEMANTIC_COLORS.plainLightAlpha16,
  ...
  borderStrongSuccess: SEMANTIC_COLORS.success80,
  borderStrongWarning: SEMANTIC_COLORS.warning40,
  borderStrongRisk: SEMANTIC_COLORS.risk50,
  borderStrongDanger: SEMANTIC_COLORS.danger80,
